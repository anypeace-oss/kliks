...
export default function Login() {
    ...
    return (
        <div className="relative bg-background flex flex-col items-center justify-center min-h-screen px-10">
            {/* <header className="absolute top-0 flex justify-between items-center w-full px-4 md:px-10 py-5">
          ...
          KLIKS
            ...
            <div className=" max-w-sm space-y-6">
                <div className="text-center flex flex-col items-center">
                    <Link href={"/"} className="text-4xl font-black font-mono">KLIKS</Link>
